...
from pydantic import Field, BaseModel, FailFast, field_validator, model_validator
...
class VectorRecord(BaseModel):
    ...
    id: str | bytes | None = Field(
        ...
        description="UUIDv7 ID as bytes. Auto-generated if not provided.", validate_default=True
    )
...
class VectorRecords(BaseModel):
    ...
    records: list[VectorRecord] = Field(description="List of vector records to be indexed.", fail_fast=True)
